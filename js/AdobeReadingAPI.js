 ...
 * @param {double} alt The accuracy of the position
 * @param {double} acc The altitude of the position
...
/**
* The following are the error codes that are propagated via the error callback
*
*/
 ...
 * <br />- <strong>This is an internal constructor and shouldn't be called by regular users.</strong>
 * @class Service for accessing ProfileImage data.
...
/**
* This API will sets the profile image for the current web overlay. 
*
* @memberOf adobeDPS-ProfileImageService.prototype
*/
...
ProfileImageService.instance = new ProfileImageService();
    /*************************************************************************
 *
 * Parts of the Camera code is taken from Cordova open-source project.
 *
 **************************************************************************/
 ...
 * <br />- <strong>This is an internal constructor and shouldn't be called by regular users.</strong>
 * @class Service for accessing Camera data.
...
/**
* These are the supported source types which need to be passed on to newImage call.
* Will open the respective picture selection
...
/**
* These are the supported camera's that need to be passed on to newImage call.
* Will open the respective camera
* @memberOf adobeDPS-CameraService.prototype
*/
...
/**
* The direction of the arrow for the popover when a gallery or camera roll is selected.
* 
*@memberOf adobeDPS-CameraService.prototype
*/
...
* camera.
* newImage has a variable called options. The currently supported options are
* 1. pictureSourceType: Whether to select a picture from galley or camera roll or launch
* camera to take a new picture. If No value is provided, A user pop up dialog to choose 
* between camera or photo library is popped up.
* 2. cameraDirection: Used only when camera is selected as pictureSource Type. Enable the 
* user to select the front or back camera
* 3. saveToPhotoAlbum: if true, the selected picture is also saved to the photo album
* 4. portraitOverlayImage: The background image to be used for the camera or selected
* picture from the album in portrait orientation
* 5. landscapeOverlayImage: The BackgroundImage to be used for the camera or selected
* picture from the album in landscape orientation.
* 6.popOverOptions: These options are only required for the Photo library/camera roll case. 
* These indicate the place where pop over need to be drawn and the arrow of the pop over.
*   x: the start x-point of the rectangle
*   y: the start y-point of the rectangle
*   width: Width of the pop over
*   height: Height of the pop over
*   popOverArrowDirection: This indicates the arrow direction for the pop up. 
*    Only used when the PictureSourceType is non-camera. The default value is ARROW_ANY
*
* @memberOf adobeDPS-CameraService.prototype
*/
